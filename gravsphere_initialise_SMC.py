...
#Code options [use proper motions so can make
#plots at the end comparing to data, but don't
#include proper motion data in the fit. Similarly
#for VSP2. This is because we don't trust either:
propermotion = 'yes'
virialshape = 'yes'
propnoprop = 'yes'
novsptwo = 'yes'
